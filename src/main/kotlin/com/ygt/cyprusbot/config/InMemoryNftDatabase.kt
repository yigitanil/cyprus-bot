...
class InMemoryNftDatabase {
    ...
    fun init() {
        map.put(48, NftMetaData(48, "HandStand",
                "http://ec2-52-56-90-225.eu-west-2.compute.amazonaws.com:8080/nft/48",
        ...
        map.put(49, NftMetaData(49, "NftArticle",
                "http://ec2-52-56-90-225.eu-west-2.compute.amazonaws.com:8080/nft/49",
