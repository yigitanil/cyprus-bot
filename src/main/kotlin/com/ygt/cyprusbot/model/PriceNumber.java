 ...
 * @see Num
 */
public final class PriceNumber implements Num {

    private static final long serialVersionUID = 785564782721079992L;

    private static final int DEFAULT_PRECISION = 32;
    private static final Logger log = LoggerFactory.getLogger(PriceNumber.class);
     ...
     */
    private PriceNumber(String val) {
     ...
     */
    private PriceNumber(String val, int precision) {
        mathContext = new MathContext(precision, RoundingMode.HALF_UP);
        delegate = new BigDecimal(val, new MathContext(precision, RoundingMode.HALF_UP));
    }

    private PriceNumber(short val) {
        mathContext = new MathContext(DEFAULT_PRECISION, RoundingMode.HALF_UP);
        delegate = new BigDecimal(val, mathContext);
    }

    private PriceNumber(int val) {
        mathContext = new MathContext(DEFAULT_PRECISION, RoundingMode.HALF_UP);
        delegate = BigDecimal.valueOf(val);
    }

    private PriceNumber(long val) {
        mathContext = new MathContext(DEFAULT_PRECISION, RoundingMode.HALF_UP);
        delegate = BigDecimal.valueOf(val);
    }

    private PriceNumber(float val) {
        mathContext = new MathContext(DEFAULT_PRECISION, RoundingMode.HALF_UP);
        delegate = new BigDecimal(val, mathContext);
    }

    private PriceNumber(double val) {
        mathContext = new MathContext(DEFAULT_PRECISION, RoundingMode.HALF_UP);
        delegate = BigDecimal.valueOf(val);
    }

    private PriceNumber(BigDecimal val, int precision) {
        mathContext = new MathContext(precision, RoundingMode.HALF_UP);
     ...
     * @return the {@code Num}
     */
    public static PriceNumber valueOf(String val) {
        if (val.equalsIgnoreCase("NAN")) {
            throw new NumberFormatException();
        }
        return new PriceNumber(val);
    }
     ...
     * @return the {@code Num}
     */
    public static PriceNumber valueOf(String val, int precision) {
        if (val.equalsIgnoreCase("NAN")) {
            throw new NumberFormatException();
        }
        return new PriceNumber(val, precision);
    }
     ...
     * @return the {@code Num}
     */
    public static PriceNumber valueOf(short val) {
        return new PriceNumber(val);
    }
     ...
     * @return the {@code Num}
     */
    public static PriceNumber valueOf(int val) {
        return new PriceNumber(val);
    }
     ...
     * @return the {@code Num}
     */
    public static PriceNumber valueOf(long val) {
        return new PriceNumber(val);
    }
     ...
     * @return the {@code Num}
     */
    public static PriceNumber valueOf(float val) {
        if (Float.isNaN(val)) {
            throw new NumberFormatException();
        }
        return new PriceNumber(val);
    ...
    public static PriceNumber valueOf(BigDecimal val) {
        return new PriceNumber(val, val.precision());
    }

    public static PriceNumber valueOf(BigDecimal val, int precision) {
        return new PriceNumber(val, precision);
    }
     ...
     * @return the {@code Num}
     */
    public static PriceNumber valueOf(double val) {
        if (Double.isNaN(val)) {
            throw new NumberFormatException();
        }
        return new PriceNumber(val);
     ...
     * @return the {@code Num}
     */
    public static PriceNumber valueOf(PriceNumber val) {
        return val;
    }
     ...
     * @return the {@code Num}
     */
    public static PriceNumber valueOf(java.lang.Number val) {
        return new PriceNumber(val.toString());
    }

    @Override
    public Function<java.lang.Number, Num> function() {
        return (number -> PriceNumber.valueOf(number.toString(), mathContext.getPrecision()));
    }
    ...
    public Num plus(Num augend) {
        ...
        BigDecimal bigDecimal = ((PriceNumber) augend).delegate;
        int precision = mathContext.getPrecision();
        BigDecimal result = delegate.add(bigDecimal, mathContext);
        return new PriceNumber(result, precision);
    }
    ...
    public Num minus(Num subtrahend) {
        ...
        BigDecimal bigDecimal = ((PriceNumber) subtrahend).delegate;
        int precision = mathContext.getPrecision();
    ...
    public Num multipliedBy(Num multiplicand) {
        ...
        BigDecimal bigDecimal = ((PriceNumber) multiplicand).delegate;
        int precision = mathContext.getPrecision();
    ...
    public Num dividedBy(Num divisor) {
        ...
        BigDecimal bigDecimal = ((PriceNumber) divisor).delegate;
        int precision = mathContext.getPrecision();
    ...
    public Num floor() {
        ...
        return new PriceNumber(delegate.setScale(0, RoundingMode.FLOOR), precision);
    }
    ...
    public Num ceil() {
        int precision = Math.max(mathContext.getPrecision(), DEFAULT_PRECISION);
        return new PriceNumber(delegate.setScale(0, RoundingMode.CEILING), precision);
    }
    ...
    public Num sqrt(int precision) {
        ...
        return PriceNumber.valueOf(estimate, precision);
    }
    ...
    public Num log() {
        ...
        if (delegate.equals(BigDecimal.ONE)) {
            logx = PriceNumber.valueOf(BigDecimal.ZERO, mathContext.getPrecision());
        } else {
            long ITER = 1000;
            ...
            logx = PriceNumber.valueOf(ret, mathContext.getPrecision());
        }
        return logx;
    }
    ...
    @Override
    public Num abs() {
        return new PriceNumber(delegate.abs(), mathContext.getPrecision());
    }
    ...
    public boolean matches(Num other, int precision) {
        Num otherNum = PriceNumber.valueOf(other.toString(), precision);
        Num thisNum = PriceNumber.valueOf(this.toString(), precision);
    ...
    public boolean isLessThanOrEqual(Num other) {
        return !other.isNaN() && delegate.compareTo(((PriceNumber) other).delegate) < 1;
    }

    @Override
    public int compareTo(Num other) {
        return other.isNaN() ? 0 : delegate.compareTo(((PriceNumber) other).delegate);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof PriceNumber)) {
            return false;
        }
        return this.delegate.compareTo(((PriceNumber) obj).delegate) == 0;
    }
    ...
    public Num pow(Num n) {
        ...
        // remainder 0 <= b < 1
        // So:
        // x^a uses PriceNumber ((PriceNumber) x).pow(int a) cannot overflow Num
        ...
        BigDecimal aplusb = (((PriceNumber) n).delegate);
        ...
        // use PriceNumber.multiply(PriceNumber)
        BigDecimal result = xpowa.multiply(new BigDecimal(xpowb));
        return new PriceNumber(result.toString());
    }
