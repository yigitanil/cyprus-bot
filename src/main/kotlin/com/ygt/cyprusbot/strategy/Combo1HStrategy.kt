...
class Combo1HStrategy(series: BarSeries) : AbstractCustomStrategy(series) {
    ...
    override fun buildStrategy(series: BarSeries): Strategy {
        ...
        val stochMinus4 = PreviousIndicator(stoch, 4)
        val stochMinus5 = PreviousIndicator(stoch, 5)
        ...
        val macd: Rule = OverIndicatorRule(ligneMACDZeroLag, signal)
        ...
        val enterRule: Rule = tilsonEntry.and(stochEntry).and(mavilimWEntry).and(macd)
